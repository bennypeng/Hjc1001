...
class UserController extends Controller
{
    ...
    public function extractMoney(Request $req) {
         ...
         * @todo 临时禁止提现的列表
         */
        if (in_array($userInfo['mobile'], array(17388727549,18165733394,18925292571,18688741116,13145835525,17301859453,15574838474,13247918228,13699865359,13763367358,13652307220,17301859453,13468601970)))
