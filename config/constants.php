...
return [
    ...
    /**
     * 比赛设置
     * 比赛ID => [[允许参赛的宠物类型]， 参加比赛需要消耗的代币，单次比赛投票次数限制， 单次投票消耗的代币，[[周几00:00到周几23:59:59], [周几00:00到周几23:59:59]]]
     */
    'MATCHES_OPTIONS'        => [
        1 => [[2, 4],    100, 5, 10, [[1, 3], [4, 6]]],
        2 => [[1, 9],    100, 5, 10, [[1, 3], [4, 6]]],
        3 => [[3, 5, 6], 100, 5, 10, [[1, 3], [4, 6]]],
        4 => [[7, 8],    100, 5, 10, [[1, 3], [4, 6]]]
    ],
